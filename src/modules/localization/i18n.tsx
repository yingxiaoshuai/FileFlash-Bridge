...
const zhCN = {
  ...
  'settings.language.description': '选择文件闪传桥的显示语言。',
  ...
  'home.shared.title': '手机共享文件',
  'home.shared.importFiles': '添加文件',
  ...
  'notice.export.batchSaved': '已处理 {{count}} 个文件的下载保存。',
  'notice.export.batchPartial':
    '已处理 {{count}} 个文件，{{failureCount}} 个失败：{{message}}',
  'error.unknown': '出现了未知错误，请稍后重试。',
  'error.exportFailed': '下载失败：{{message}}',
  'project.defaultTitle': '项目 {{count}}',
  'project.currentRound': '当前分享轮次',
  'portal.title': '{{deviceName}} 的文件闪传桥',
  'portal.heroTitle': '浏览器投递',
  'portal.deviceLabel': '设备：{{deviceName}}',
  'portal.eyebrowUpload': '拖拽投递',
  'portal.eyebrowText': '粘贴发送',
  'portal.eyebrowShared': '从手机下载',
  ...
  'portal.download.select': '选择',
  'portal.download.selectAll': '全选',
  'portal.download.clearSelection': '清空',
  'portal.download.selectedCount': '已选 {{count}} 个',
  'portal.download.selectedButton': '下载选中',
  'portal.download.noneSelected': '请先选择要下载的文件。',
  'portal.download.batchComplete': '选中的文件已全部发起下载。',
  'portal.download.saveUnsupported':
    '当前浏览器不支持大文件直接保存，请使用支持文件保存的浏览器，或先下载较小文件。',
...
const enUS: Record<TranslationKey, string> = {
  ...
  'home.shared.title': 'Phone Shared Files',
  'home.shared.importFiles': 'Add files',
  ...
  'notice.export.batchSaved': 'Handled download saving for {{count}} files.',
  'notice.export.batchPartial':
    'Handled {{count}} files; {{failureCount}} failed: {{message}}',
  'error.unknown': 'An unknown error occurred. Please try again later.',
  'error.exportFailed': 'Download failed: {{message}}',
  ...
  'portal.eyebrowShared': 'Download From Phone',
  ...
  'portal.sectionShared': 'Download Phone Shared Files',
  ...
  'portal.download.select': 'Select',
  'portal.download.selectAll': 'Select all',
  'portal.download.clearSelection': 'Clear',
